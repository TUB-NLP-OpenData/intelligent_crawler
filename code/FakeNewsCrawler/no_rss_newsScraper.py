...
with open('input/no_rss_mixed_languages.json') as data_file:
...
try:
    with open('Output/no_rss_mixed_languages_out.json', 'w') as outfile:
...
#Decrypteurs
#FactCheck Gorgia
#Grupo La Republica Piblicaciones SA ?
#Kompas
#Knack Magazine
#Myth Detector
#Patrikrinka 15min
#Taiwan Fact Checker Center
#Delfi
#Vera Files
#dpa Faktencheck
#Dogruluk Pay1
